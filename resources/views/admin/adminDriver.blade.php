...
@section('body')
    <div class="body">
        <div class="halaman-admin-driver">
                    ...
                    <ul>
                        <li>
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                data-bs-target="#inputDriverAdmin">Tambah</button>
                        </li>
                        <li>
                            <button type="button" class="btn btn-success tombol-input-akun" data-bs-toggle="modal"
                                data-bs-target="#inputAkunDriverAdmin">Input Akun</button>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            {{-- Modal --}}
            <div class="modal fade" id="inputDriverAdmin" tabindex="-1" aria-labelledby="exampleModalLabel"
                aria-hidden="true">
            ...
            <div class="modal fade" id="inputAkunDriverAdmin" tabindex="-1" aria-labelledby="exampleModalLabel"
                aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <form action="/admin/inputUser/driver" method="POST">
                            <div class="modal-body">
                                @csrf
                                <div class="kolom1">
                                    <div class="item container1">
