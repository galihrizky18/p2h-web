...
@section('body')
    <div class="body">
        <div class="halaman-admin-driver">
                    ...
                    <ul>
                        <li>
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                data-bs-target="#tambahDriverSuper">Tambah</button>
                        </li>
                        <li>
                            <button type="button" class="btn btn-success tombol-input-akun" data-bs-toggle="modal"
                                data-bs-target="#tambahAkunDriverSuper">Input Akun</button>
                        </li>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="tombol">
                                            ...
                                            <form action="/super-admin/driver/{{ $d['id'] }}" method="POST"
                                                class="d-inline">
                                                @csrf
            ...
            {{-- modal --}}
            <div class="modal fade" id="tambahDriverSuper" tabindex="-1" aria-labelledby="exampleModalLabel"
                aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h1 class="modal-title fs-5" id="exampleModalLabel">Input Driver</h1>
            ...
            <div class="modal fade" id="tambahAkunDriverSuper" tabindex="-1" aria-labelledby="exampleModalLabel"
                aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h1 class="modal-title fs-5" id="exampleModalLabel">Input Akun Driver</h1>
                                        ...
                                        <select name="id_driver" id="id_driver"
                                            ...
                                            @foreach ($data as $data)
                                                <option value="{{ $data->id }}"
                                                    data-nama-driver="{{ $data->first_name }} {{ $data->last_name }}">
                                                    {{ $data->id }} - {{ $data->first_name }}</option>
                                            @endforeach
                                        </select>
                                        @error('id_driver')
                                            <span class="error">{{ $message }}</span>
