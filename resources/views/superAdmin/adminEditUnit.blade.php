...
<div class="body">
    <div class="halaman-admin-edit-unit">
        ...
        <div class="edit-unit-card">
            <form action="/super-admin/unit/{{ $unit->id }}" method="POST">
                @csrf
                @method('PUT')
                <div class="kolom1">
                    ...
                    <div class="item container6">
                        ...
                        <input type="number" min="1900" max="2099" step="1" value="{{ $unit->tahun_pembuatan }}" name="tahun_pembuatan" id="tahun_pembuatan">
                    </div>
                </div>
                <div class="tombol">
